...
Note right of browser: The note title input is submitted to the server through the endpoint /new_note
activate server
...
activate server
server-->>browser: [{"content": "", "date": "2026-01-03T09:38:48.635Z"}, ... ]
deactivate server
